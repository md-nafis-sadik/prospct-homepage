...
const chunkArray = (array, size) => {
  ...
  const options = [
    {
      title: 'Why Prospct',
      subOptions: ['The platform', 'Our data'],
    },
    {
      title: 'Solutions',
      subOptions: ['Sales', 'Marketing'],
    },
  ];
  ...
  const handleTabClick = (target) => {
    ...
    <>
        ...
        {/* sidepanel why adopt  start */}
        <div className='p-2'>
      {options.map((option, index) => (
        <div key={index}>
          <div
            className='option flex justify-between items-center p-1 cursor-pointer'
          ...
          <div
            className={`subOption p-1 transition-all duration-200 ease-in-out overflow-hidden transform ${
              activeIndex === index ? 'max-h-screen scale-y-100' : 'max-h-0 scale-y-0'
            }`}
            style={{ transformOrigin: 'top' }}
          >
            {option.subOptions.map((subOption, subIndex) => (
              <div key={subIndex} className='px-1 cursor-pointer'>
                {subOption}
              </div>
            ))}
          </div>
    ...
    <div className="parent-container" id="idparentcontainer"  ref={parentContainerRef}>
        ...
        <section className="main-hero-container w-full" id="main-hero-container"  ref={mainHeroContainerRef}>
          ...
          <nav className="navbar" id="navbar-controller"  ref={headerRef}>
             ...
             <div className='logo-div'>
              ...
              <div className="logo-container">
                ...
                <div className="nav-item why-adept-nav-item">
                  <a href="#" className="nav-link">Why Adapt?</a>
            ...
            <div className="nav-right" id="nav-right"  ref={navRightRef}>
              ...
              <a href="#" className="btn btn-solid">Start Free Trial</a>
              <FaBars
                className="nav-right-ham-burger-menu"
                onClick={toggleMenu}
              />
            </div>
          </nav>
      ...
      <div className="b-i-s lg:bg-white" ></div>
            ...
            <div className="run-s-c-l-s-content-wrapper">
              <div className="run-s-c-l-s-flex-row">
                ...
                <aside className="run-s-c-l-s-image-column">
                  ...
                  poster="https://www.Prospct.com/wp-content/uploads/2023/08/hompage_04.png"
                  autoPlay
                  loop
                  muted
                  playsInline
                >
                  <source
                    src="/public/videos/main_Filters-3.webm"
                    type="video/webm"
                  />
                  Your browser does not support the video tag.
                </video>
